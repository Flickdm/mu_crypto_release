...
// GENERATED ON: 2025-Jan-16 13:25:08
// DO NOT MODIFY
// ------------------------------------------------------------------------------
#ifndef BASE_CRYPT_API_LIB_
#define BASE_CRYPT_API_LIB_

#include <Uefi.h>
// =============================================================================
// Library for BaseCrypt
// =============================================================================
...
BOOLEAN
EFIAPI
HmacSha256SetKey (  VOID         *HmacContext,
  CONST UINT8  *Key,
  UINTN        KeySize);
...
BOOLEAN
EFIAPI
HmacSha256Duplicate (  CONST VOID  *HmacContext,
  VOID        *NewHmacContext);
...
BOOLEAN
EFIAPI
HmacSha256Update (  VOID        *HmacContext,
  CONST VOID  *Data,
  UINTN       DataSize);
...
BOOLEAN
EFIAPI
HmacSha256Final (  VOID   *HmacContext,
  UINT8  *HmacValue);
...
BOOLEAN
EFIAPI
HmacSha384SetKey (  VOID         *HmacContext,
  CONST UINT8  *Key,
  UINTN        KeySize);
...
BOOLEAN
EFIAPI
HmacSha384Duplicate (  CONST VOID  *HmacContext,
  VOID        *NewHmacContext);
...
BOOLEAN
EFIAPI
HmacSha384Update (  VOID        *HmacContext,
  CONST VOID  *Data,
  UINTN       DataSize);
...
BOOLEAN
EFIAPI
HmacSha384Final (  VOID   *HmacContext,
  UINT8  *HmacValue);
...
BOOLEAN
EFIAPI
AesCbcEncrypt (  IN   VOID         *AesContext,
...
BOOLEAN
EFIAPI
AesCbcDecrypt (  IN   VOID         *AesContext,
  IN   CONST UINT8  *Input,
  IN   UINTN        InputSize,
  IN   CONST UINT8  *Ivec,
  OUT  UINT8        *Output);
...
BOOLEAN
EFIAPI
AeadAesGcmEncrypt (  IN   CONST UINT8  *Key,
  IN   UINTN        KeySize,
  IN   CONST UINT8  *Iv,
  IN   UINTN        IvSize,
...
BOOLEAN
EFIAPI
AeadAesGcmDecrypt (  IN   CONST UINT8  *Key,
  IN   UINTN        KeySize,
  IN   CONST UINT8  *Iv,
  IN   UINTN        IvSize,
  IN   CONST UINT8  *AData,
...
VOID *
EFIAPI
BigNumFromBin (  IN CONST UINT8  *Buf,
  IN UINTN        Len);
...
BOOLEAN
EFIAPI
BigNumExpMod (  IN CONST VOID  *BnA,
  IN CONST VOID  *BnP,
  IN CONST VOID  *BnM,
  OUT VOID       *BnRes);
...
BOOLEAN
EFIAPI
BigNumInverseMod (  IN CONST VOID  *BnA,
  IN CONST VOID  *BnM,
  OUT VOID       *BnRes);
...
BOOLEAN
EFIAPI
BigNumMulMod (  IN CONST VOID  *BnA,
  IN CONST VOID  *BnB,
  IN CONST VOID  *BnM,
  OUT VOID       *BnRes);
...
BOOLEAN
EFIAPI
BigNumSqrMod (  IN CONST VOID  *BnA,
  IN CONST VOID  *BnM,
  OUT VOID       *BnRes);
...
VOID
EFIAPI
BigNumContextFree (  IN VOID  *BnCtx);
...
BOOLEAN
EFIAPI
BigNumAddMod (  IN CONST VOID  *BnA,
  IN CONST VOID  *BnB,
  IN CONST VOID  *BnM,
  OUT VOID       *BnRes);
...
BOOLEAN
EFIAPI
HkdfSha256ExtractAndExpand (  IN   CONST UINT8  *Key,
  IN   UINTN        KeySize,
  IN   CONST UINT8  *Salt,
  IN   UINTN        SaltSize,
  IN   CONST UINT8  *Info,
...
BOOLEAN
EFIAPI
HkdfSha256Extract (  IN CONST UINT8  *Key,
  IN UINTN        KeySize,
  IN CONST UINT8  *Salt,
  IN UINTN        SaltSize,
  OUT UINT8       *PrkOut,
...
BOOLEAN
EFIAPI
HkdfSha256Expand (  IN   CONST UINT8  *Prk,
  IN   UINTN        PrkSize,
  IN   CONST UINT8  *Info,
  IN   UINTN        InfoSize,
  OUT  UINT8        *Out,
...
BOOLEAN
EFIAPI
HkdfSha384ExtractAndExpand (  IN   CONST UINT8  *Key,
  IN   UINTN        KeySize,
  IN   CONST UINT8  *Salt,
  IN   UINTN        SaltSize,
  IN   CONST UINT8  *Info,
...
BOOLEAN
EFIAPI
HkdfSha384Extract (  IN CONST UINT8  *Key,
  IN UINTN        KeySize,
  IN CONST UINT8  *Salt,
  IN UINTN        SaltSize,
  OUT UINT8       *PrkOut,
...
BOOLEAN
EFIAPI
HkdfSha384Expand (  IN   CONST UINT8  *Prk,
  IN   UINTN        PrkSize,
  IN   CONST UINT8  *Info,
  IN   UINTN        InfoSize,
  OUT  UINT8        *Out,
...
BOOLEAN
EFIAPI
AuthenticodeVerify (  IN  CONST UINT8  *AuthData,
  IN  UINTN        DataSize,
...
BOOLEAN
EFIAPI
Pkcs1v2Encrypt (  IN   CONST UINT8  *PublicKey,
...
BOOLEAN
EFIAPI
Pkcs1v2Decrypt (  IN   CONST UINT8  *PrivateKey,
...
BOOLEAN
EFIAPI
RsaOaepEncrypt (  IN   VOID         *RsaContext,
  IN   UINT8        *InData,
  IN   UINTN        InDataSize,
  IN   CONST UINT8  *PrngSeed   OPTIONAL,
  IN   UINTN        PrngSeedSize   OPTIONAL,
...
BOOLEAN
EFIAPI
RsaOaepDecrypt (  IN   VOID    *RsaContext,
  IN   UINT8   *EncryptedData,
  IN   UINTN   EncryptedDataSize,
  IN   UINT16  DigestLen OPTIONAL,
  OUT  UINT8   **OutData,
...
BOOLEAN
EFIAPI
Pkcs5HashPassword (  IN  UINTN        PasswordLength,
...
BOOLEAN
EFIAPI
Pkcs7GetSigners (  IN  CONST UINT8  *P7Data,
  IN  UINTN        P7Length,
  OUT UINT8        **CertStack,
...
VOID
EFIAPI
Pkcs7FreeSigners (  IN  UINT8  *Certs);
...
BOOLEAN
EFIAPI
Pkcs7GetCertificatesList (  IN  CONST UINT8  *P7Data,
  IN  UINTN        P7Length,
...
BOOLEAN
EFIAPI
Pkcs7Sign (  IN   CONST UINT8  *PrivateKey,
  IN   UINTN        PrivateKeySize,
...
BOOLEAN
EFIAPI
Pkcs7Verify (  IN  CONST UINT8  *P7Data,
  IN  UINTN        P7Length,
  IN  CONST UINT8  *TrustedCert,
  IN  UINTN        CertLength,
...
RETURN_STATUS
EFIAPI
VerifyEKUsInPkcs7Signature (  IN  CONST UINT8   *Pkcs7Signature,
...
BOOLEAN
EFIAPI
Pkcs7GetAttachedContent (  IN  CONST UINT8  *P7Data,
  IN  UINTN        P7Length,
  OUT VOID         **Content,
...
BOOLEAN
EFIAPI
DhGenerateParameter (  IN OUT  VOID   *DhContext,
  IN      UINTN  Generator,
...
BOOLEAN
EFIAPI
DhSetParameter (  IN OUT  VOID         *DhContext,
  IN      UINTN        Generator,
  IN      UINTN        PrimeLength,
...
BOOLEAN
EFIAPI
DhGenerateKey (  IN OUT  VOID   *DhContext,
  OUT     UINT8  *PublicKey,
...
BOOLEAN
EFIAPI
DhComputeKey (  IN OUT  VOID         *DhContext,
...
VOID *
EFIAPI
EcGroupInit (  IN UINTN  CryptoNid);
...
BOOLEAN
EFIAPI
EcGroupGetCurve (  IN CONST VOID  *EcGroup,
  OUT VOID       *BnPrime,
  OUT VOID       *BnA,
  OUT VOID       *BnB,
  IN VOID        *BnCtx);
...
BOOLEAN
EFIAPI
EcGroupGetOrder (  IN VOID   *EcGroup,
  OUT VOID  *BnOrder);
...
VOID *
EFIAPI
EcPointInit (  IN CONST VOID  *EcGroup);
...
BOOLEAN
EFIAPI
EcPointGetAffineCoordinates (  IN CONST VOID  *EcGroup,
...
BOOLEAN
EFIAPI
EcPointSetAffineCoordinates (  IN CONST VOID  *EcGroup,
  IN VOID        *EcPoint,
  IN CONST VOID  *BnX,
  IN CONST VOID  *BnY,
  IN VOID        *BnCtx);
...
BOOLEAN
EFIAPI
EcPointAdd (  IN CONST VOID  *EcGroup,
...
BOOLEAN
EFIAPI
EcPointMul (  IN CONST VOID  *EcGroup,
  OUT VOID       *EcPointResult,
  IN CONST VOID  *EcPoint,
...
BOOLEAN
EFIAPI
EcPointInvert (  IN CONST VOID  *EcGroup,
  IN OUT VOID    *EcPoint,
  IN VOID        *BnCtx);
...
BOOLEAN
EFIAPI
EcPointIsOnCurve (  IN CONST VOID  *EcGroup,
  IN CONST VOID  *EcPoint,
  IN VOID        *BnCtx);
...
BOOLEAN
EFIAPI
EcPointIsAtInfinity (  IN CONST VOID  *EcGroup,
  IN CONST VOID  *EcPoint);
...
BOOLEAN
EFIAPI
EcPointEqual (  IN CONST VOID  *EcGroup,
  IN CONST VOID  *EcPointA,
  IN CONST VOID  *EcPointB,
  IN VOID        *BnCtx);
...
BOOLEAN
EFIAPI
EcPointSetCompressedCoordinates (  IN CONST VOID  *EcGroup,
  IN VOID        *EcPoint,
  IN CONST VOID  *BnX,
  IN UINT8       YBit,
  IN VOID        *BnCtx);
...
BOOLEAN
EFIAPI
EcGenerateKey (  IN OUT  VOID   *EcContext,
  OUT     UINT8  *PublicKey,
  IN OUT  UINTN  *PublicKeySize);
...
BOOLEAN
EFIAPI
EcGetPubKey (  IN OUT  VOID   *EcContext,
  OUT     UINT8  *PublicKey,
  IN OUT  UINTN  *PublicKeySize);
...
BOOLEAN
EFIAPI
EcDhComputeKey (  IN OUT  VOID         *EcContext,
...
BOOLEAN
EFIAPI
EcGetPrivateKeyFromPem (  IN   CONST UINT8  *PemData,
  IN   UINTN        PemSize,
  IN   CONST CHAR8  *Password,
  OUT  VOID         **EcContext);
...
BOOLEAN
EFIAPI
EcGetPublicKeyFromX509 (  IN   CONST UINT8  *Cert,
  IN   UINTN        CertSize,
  OUT  VOID         **EcContext);
...
BOOLEAN
EFIAPI
RsaSetKey (  IN OUT  VOID         *RsaContext,
...
BOOLEAN
EFIAPI
RsaGetKey (  IN OUT  VOID         *RsaContext,
  IN      RSA_KEY_TAG  KeyTag,
  OUT     UINT8        *BigNumber,
  IN OUT  UINTN        *BnSize);
...
BOOLEAN
EFIAPI
RsaGenerateKey (  IN OUT  VOID         *RsaContext,
...
BOOLEAN
EFIAPI
RsaCheckKey (  IN  VOID  *RsaContext);
...
BOOLEAN
EFIAPI
RsaPkcs1Sign (  IN      VOID         *RsaContext,
  IN      CONST UINT8  *MessageHash,
  IN      UINTN        HashSize,
  OUT     UINT8        *Signature,
  IN OUT  UINTN        *SigSize);
...
BOOLEAN
EFIAPI
RsaPkcs1Verify (  IN  VOID         *RsaContext,
  IN  CONST UINT8  *MessageHash,
  IN  UINTN        HashSize,
  IN  CONST UINT8  *Signature,
  IN  UINTN        SigSize);
...
BOOLEAN
EFIAPI
RsaPssVerify (  IN  VOID         *RsaContext,
  IN  CONST UINT8  *Message,
  IN  UINTN        MsgSize,
  IN  CONST UINT8  *Signature,
  IN  UINTN        SigSize,
...
BOOLEAN
EFIAPI
RsaGetPrivateKeyFromPem (  IN   CONST UINT8  *PemData,
  IN   UINTN        PemSize,
  IN   CONST CHAR8  *Password,
  OUT  VOID         **RsaContext);
...
BOOLEAN
EFIAPI
RsaGetPublicKeyFromX509 (  IN   CONST UINT8  *Cert,
  IN   UINTN        CertSize,
  OUT  VOID         **RsaContext);
...
BOOLEAN
EFIAPI
X509GetSubjectName (  IN      CONST UINT8  *Cert,
  IN      UINTN        CertSize,
...
RETURN_STATUS
EFIAPI
X509GetCommonName (  IN      CONST UINT8  *Cert,
  IN      UINTN        CertSize,
...
RETURN_STATUS
EFIAPI
X509GetOrganizationName (  IN      CONST UINT8  *Cert,
  IN      UINTN        CertSize,
...
BOOLEAN
EFIAPI
X509VerifyCert (  IN  CONST UINT8  *Cert,
  IN  UINTN        CertSize,
...
BOOLEAN
EFIAPI
X509ConstructCertificate (  IN   CONST UINT8  *Cert,
  IN   UINTN        CertSize,
...
BOOLEAN
EFIAPI
X509ConstructCertificateStackV (  IN OUT  UINT8    **X509Stack,
  IN      VA_LIST  Args);
...
BOOLEAN
EFIAPI
X509ConstructCertificateStack (  IN OUT  UINT8  **X509Stack,
  ...);
...
VOID
EFIAPI
X509StackFree (  IN  VOID  *X509Stack);
...
BOOLEAN
EFIAPI
X509GetTBSCert (  IN  CONST UINT8  *Cert,
  IN  UINTN        CertSize,
  OUT UINT8        **TBSCert,
...
BOOLEAN
EFIAPI
RandomSeed (  IN  CONST  UINT8  *Seed  OPTIONAL,
  IN  UINTN         SeedSize);
...
BOOLEAN
EFIAPI
RandomBytes (  OUT  UINT8  *Output,
  IN   UINTN  Size);

#endif // BASE_CRYPT_API_LIB_
