...
BOOLEAN
EFIAPI
Md5Update (  IN OUT VOID    *HashContext,
  IN CONST VOID  *Data,
  IN UINTN       DataSize);
...
BOOLEAN
EFIAPI
Md5Final (  IN OUT  VOID   *HashContext,
...
BOOLEAN
EFIAPI
Md5Duplicate (  IN CONST VOID  *HashContext,
...
BOOLEAN
EFIAPI
Sha1Update (  IN OUT VOID    *HashContext,
  IN CONST VOID  *Data,
  IN UINTN       DataSize);
...
BOOLEAN
EFIAPI
Sha1Final (  IN OUT  VOID   *HashContext,
  OUT     UINT8  *HashDigest);
...
BOOLEAN
EFIAPI
Sha1HashAll (  IN CONST VOID  *Data,
  IN UINTN       DataSize,
  OUT UINT8      *HashDigest);
...
BOOLEAN
EFIAPI
Sha1Duplicate (  IN CONST VOID  *HashContext,
  OUT VOID       *NewHashContext);
...
BOOLEAN
EFIAPI
Sha256Init (  OUT VOID  *HashContext);
...
BOOLEAN
EFIAPI
Sha256Update (  IN OUT VOID    *HashContext,
  IN CONST VOID  *Data,
  IN UINTN       DataSize);
...
BOOLEAN
EFIAPI
Sha256Final (  IN OUT  VOID   *HashContext,
  OUT     UINT8  *HashDigest);
...
BOOLEAN
EFIAPI
Sha256HashAll (  IN CONST VOID  *Data,
  IN UINTN       DataSize,
  OUT UINT8      *HashDigest);
...
BOOLEAN
EFIAPI
Sha256Duplicate (  IN CONST VOID  *HashContext,
  OUT VOID       *NewHashContext);
...
BOOLEAN
EFIAPI
Sha512Init (  OUT  VOID  *Sha512Context);
...
BOOLEAN
EFIAPI
Sha512Duplicate (  IN   CONST VOID  *Sha512Context,
...
BOOLEAN
EFIAPI
Sha512Update (  IN OUT  VOID        *Sha512Context,
  IN      CONST VOID  *Data,
  IN      UINTN       DataSize);
...
BOOLEAN
EFIAPI
Sha512Final (  IN OUT  VOID   *Sha512Context,
  OUT     UINT8  *HashValue);
...
BOOLEAN
EFIAPI
Sha512HashAll (  IN   CONST VOID  *Data,
  IN   UINTN       DataSize,
  OUT  UINT8       *HashValue);
...
BOOLEAN
EFIAPI
Sm3Duplicate (  IN   CONST VOID  *Sm3Context,
...
BOOLEAN
EFIAPI
Sm3Update (  IN OUT  VOID        *Sm3Context,
  IN      CONST VOID  *Data,
  IN      UINTN       DataSize);
...
BOOLEAN
EFIAPI
Sm3Final (  IN OUT  VOID   *Sm3Context,
  OUT     UINT8  *HashValue);
