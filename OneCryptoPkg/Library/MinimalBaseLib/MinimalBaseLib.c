...
/**
  ...
  @param  Char  The ASCII character to check.

  @retval TRUE   The character is a whitespace character (space, tab, vertical tab, form feed, carriage return, or newline).
...
/**
  Check if a character is a decimal digit character.

  @param  Char  The ASCII character to check.

  @retval TRUE   The character is a decimal digit ('0' through '9').
  @retval FALSE  The character is not a decimal digit.
**/
BOOLEAN
...
/**
  Check if two ASCII string buffers do not overlap.

  @param  Destination  A pointer to the destination ASCII string buffer.
  @param  DestMax      The maximum number of Destination ASCII characters.
  @param  Source       A pointer to the source ASCII string buffer.
  @param  SourceLen    The length of the source ASCII string.

  @retval TRUE   The buffers do not overlap.
  @retval FALSE  The buffers overlap.
**/
BOOLEAN
