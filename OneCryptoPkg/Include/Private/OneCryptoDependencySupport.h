...
//
// FILE_GUID(76ABA88D-9D16-49A2-AA3A-DB6112FAC5CC) of OneCryptoMmBin.inf
//
#define ONE_CRYPTO_BINARY_GUID  { 0x76ABA88D, 0x9D16, 0x49A2, { 0xAA, 0x3A, 0xDB, 0x61, 0x12, 0xFA, 0xC5, 0xCC } }
...
#define ONE_CRYPTO_MM_CONSTRUCTOR_PROTOCOL_SIGNATURE  SIGNATURE_32('O', 'N', 'E', 'C')
